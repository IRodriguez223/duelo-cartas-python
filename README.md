# 🃏 Simulador de Duelo de Cartas em Python

💡 *Este projeto foi desenvolvido por mim, **Igor Luciano Rodrigues**, como parte do meu portfólio de transição de carreira para a área de TI.*

---

## 📖 Sobre o Projeto
Desenvolvi este simulador de duelo de cartas em Python 3 com o objetivo de aplicar e consolidar meus conhecimentos em **lógica de programação**, **estruturas de dados** e **boas práticas de codificação** (PEP 8).
...
Embora eu tenha construído este projeto em Python, a lógica de organização e o uso de dicionários que apliquei aqui são fundamentais para o meu entendimento em **Segurança da Informação** (especialmente na manipulação de dados e hashes).
Além disso, essa base lógica prepara o terreno para eu desenvolver **lógicas complexas no Front-end** futuramente, utilizando estruturas similares como objetos JSON.

---
## 👤 Contato
- **Nome:** Igor Luciano Rodrigues
...
[LinkedIn](https://www.linkedin.com/in/igor-luciano-rodrigues-b112b926a/)
---
